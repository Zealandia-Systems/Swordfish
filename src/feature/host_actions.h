...
void host_action(const char* type, int count, ...);
  ...
  void host_action_notify(const char * const message);
	...
	void host_prompt(const PromptReason reason, PGM_P const pstr, PGM_P const btn1);
  void host_prompt(const PromptReason reason, PGM_P const pstr, PGM_P const btn1, PGM_P const btn2);
