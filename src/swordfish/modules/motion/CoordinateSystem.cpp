...
namespace swordfish::motion {
	...
	core::ObjectField<core::Vector3> CoordinateSystem::__offsetField = { "offset", 0 };
	...
	CoordinateSystem::CoordinateSystem(core::Object* parent) : data::Record(parent), _pack(__schema, *this) {
