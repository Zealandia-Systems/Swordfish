...
namespace swordfish::tools {
	...
	private:
		static core::ValueField<float32_t> __diameterField;
		static core::ValueField<float32_t> __lengthField;
	...
	public:
		ToolGeometry(core::Object* parent) : core::Object(parent), _pack(__schema, *this) {
