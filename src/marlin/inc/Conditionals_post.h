 ...
 */
  ...
  #endif
	#if HAS_TOOL_PROBE
		#define ENDSTOPPULLDOWN_TOOL_PROBE
	#endif
	#if HAS_WORK_PROBE
		#define ENDSTOPPULLDOWN_WORK_PROBE
	#endif
	#if HAS_ESTOP
		#define ESTOP_PULLDOWN
	#endif
#endif
...
#if PIN_EXISTS(B_ENABLE)
  #define HAS_B_ENABLE 1
#endif
#if PIN_EXISTS(B_DIR)
  #define HAS_B_DIR 1
#endif
#if PIN_EXISTS(B_STEP)
  #define HAS_B_STEP 1
#endif
#if PIN_EXISTS(B_MS1)
  #define HAS_B_MS_PINS 1
#endif

#if PIN_EXISTS(C_ENABLE)
  #define HAS_C_ENABLE 1
#endif
#if PIN_EXISTS(C_DIR)
  #define HAS_C_DIR 1
#endif
#if PIN_EXISTS(C_STEP)
  #define HAS_C_STEP 1
#endif
#if PIN_EXISTS(C_MS1)
  #define HAS_C_MS_PINS 1
#endif
