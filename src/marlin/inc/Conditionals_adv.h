...
#	define _MODBUS_TYPE_CHANGRONG_H100 1
#	define _MODBUS_TYPE(V)             _CAT(_MODBUS_TYPE_, V)
#	define MODBUS_TYPE_IS(V)           (_MODBUS_TYPE(SPINDLE_MODBUS_TYPE) == _MODBUS_TYPE(V))
#endif
