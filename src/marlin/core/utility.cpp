...
void log_machine_info() {
	...
	SERIAL_ECHOLNPGM("Probe: " TERN_(PROBE_MANUALLY, "PROBE_MANUALLY")
...
#		endif
	...
	serialprintPGM(probe.offset.z < 0 ? PSTR("Below") : probe.offset.z > 0 ? PSTR("Above")
	                                                                       : PSTR("Same Z as"));
...
#	if HAS_ABL_OR_UBL
	SERIAL_ECHOPGM("Auto Bed Leveling: " TERN_(AUTO_BED_LEVELING_LINEAR, "LINEAR")
