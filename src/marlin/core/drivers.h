...
#define AXIS_DRIVER_TYPE_A2(T)  (NUM_A_STEPPER_DRIVERS >= 2 && _AXIS_DRIVER_TYPE(A2, T))

#define AXIS_DRIVER_TYPE(A, T)  AXIS_DRIVER_TYPE_##A(T)

#define HAS_DRIVER(T)           (AXIS_DRIVER_TYPE_X(T) || AXIS_DRIVER_TYPE_Y(T) || AXIS_DRIVER_TYPE_Z(T) || AXIS_DRIVER_TYPE_X2(T) || AXIS_DRIVER_TYPE_Y2(T) || AXIS_DRIVER_TYPE_Z2(T) || AXIS_DRIVER_TYPE_Z3(T) || AXIS_DRIVER_TYPE_Z4(T) || AXIS_DRIVER_TYPE_A(T) || AXIS_DRIVER_TYPE_A2(T))
...
#if (HAS_DRIVER(TMC2130) || HAS_DRIVER(TMC2160) || HAS_DRIVER(TMC2208) || HAS_DRIVER(TMC2209) || HAS_DRIVER(TMC2660) || HAS_DRIVER(TMC5130) || HAS_DRIVER(TMC5160))
#	define HAS_TRINAMIC_CONFIG 1
#endif

#define HAS_TRINAMIC HAS_TRINAMIC_CONFIG

#if (HAS_DRIVER(TMC2130_STANDALONE) || HAS_DRIVER(TMC2160_STANDALONE) || HAS_DRIVER(TMC2208_STANDALONE) || HAS_DRIVER(TMC2209_STANDALONE) || HAS_DRIVER(TMC26X_STANDALONE) || HAS_DRIVER(TMC2660_STANDALONE) || HAS_DRIVER(TMC5130_STANDALONE) || HAS_DRIVER(TMC5160_STANDALONE))
...
#define AXIS_IS_TMC(A)          (AXIS_DRIVER_TYPE(A, TMC2130) || AXIS_DRIVER_TYPE(A, TMC2160) || AXIS_DRIVER_TYPE(A, TMC2208) || AXIS_DRIVER_TYPE(A, TMC2209) || AXIS_DRIVER_TYPE(A, TMC2660) || AXIS_DRIVER_TYPE(A, TMC5130) || AXIS_DRIVER_TYPE(A, TMC5160))

// Test for a driver that uses SPI - this allows checking whether a _CS_ pin
// is considered sensitive
#define AXIS_HAS_SPI(A)         (AXIS_DRIVER_TYPE(A, TMC2130) || AXIS_DRIVER_TYPE(A, TMC2160) || AXIS_DRIVER_TYPE(A, TMC2660) || AXIS_DRIVER_TYPE(A, TMC5130) || AXIS_DRIVER_TYPE(A, TMC5160))
...
#define AXIS_HAS_STALLGUARD(A)  (AXIS_DRIVER_TYPE(A, TMC2130) || AXIS_DRIVER_TYPE(A, TMC2160) || AXIS_DRIVER_TYPE(A, TMC2209) || AXIS_DRIVER_TYPE(A, TMC2660) || AXIS_DRIVER_TYPE(A, TMC5130) || AXIS_DRIVER_TYPE(A, TMC5160))

#define AXIS_HAS_STEALTHCHOP(A) (AXIS_DRIVER_TYPE(A, TMC2130) || AXIS_DRIVER_TYPE(A, TMC2160) || AXIS_DRIVER_TYPE(A, TMC2208) || AXIS_DRIVER_TYPE(A, TMC2209) || AXIS_DRIVER_TYPE(A, TMC5130) || AXIS_DRIVER_TYPE(A, TMC5160))

#define AXIS_HAS_SG_RESULT(A)   (AXIS_DRIVER_TYPE(A, TMC2130) || AXIS_DRIVER_TYPE(A, TMC2160) || AXIS_DRIVER_TYPE(A, TMC2208) || AXIS_DRIVER_TYPE(A, TMC2209) || AXIS_DRIVER_TYPE(A, TMC2660))

#define AXIS_HAS_COOLSTEP(A)    (AXIS_DRIVER_TYPE(A, TMC2130) || AXIS_DRIVER_TYPE(A, TMC2209) || AXIS_DRIVER_TYPE(A, TMC5130) || AXIS_DRIVER_TYPE(A, TMC2660) || AXIS_DRIVER_TYPE(A, TMC5160))
...
#define ANY_AXIS_HAS(T)         (AXIS_HAS_##T(X) || AXIS_HAS_##T(Y) || AXIS_HAS_##T(Z) || AXIS_HAS_##T(X2) || AXIS_HAS_##T(Y2) || AXIS_HAS_##T(Z2) || AXIS_HAS_##T(Z3) || AXIS_HAS_##T(Z4) || AXIS_HAS_##T(A) || AXIS_HAS_##T(A2))
