...
void GcodeSuite::M24() {
  ...
  if (card.isFileOpen()) {
    ...
    TERN_(POWER_LOSS_RECOVERY, recovery.prepare());
      ...
      host_action_resume();
    #endif
    TERN_(HOST_PROMPT_SUPPORT, host_prompt(PROMPT_INFO, PSTR("Resuming SD"), DISMISS_STR));
  #endif
...
void GcodeSuite::M25() {
    ...
    #if ENABLED(HOST_ACTION_COMMANDS)
      TERN_(HOST_PROMPT_SUPPORT, host_prompt(PROMPT_PAUSE_RESUME, PSTR("Pause SD"), PSTR("Resume")));
