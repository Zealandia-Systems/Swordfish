...
void GcodeSuite::M111() {
	if (parser.seen('S'))
		marlin_debug_flags = parser.intval('S');
	...
	static PGMSTR(str_debug_32, STR_DEBUG_LEVELING);
	static PGMSTR(str_debug_64, STR_DEBUG_MESH_LEVEL);
#endif
	static PGMSTR(str_debug_128, STR_DEBUG_SPINDLE);
	static PGMSTR(str_debug_256, STR_DEBUG_SWORDFISH);

	static PGM_P const debug_strings[] PROGMEM = {
		str_debug_1, str_debug_2, str_debug_4, str_debug_8, str_debug_16,
		TERN(DEBUG_LEVELING_FEATURE, str_debug_32, nullptr),
		TERN(DEBUG_LEVELING_FEATURE, str_debug_64, nullptr),
		str_debug_128, str_debug_256
	};
