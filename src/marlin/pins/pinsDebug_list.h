...
#endif
#if PIN_EXISTS(COOLANT_AIR)
REPORT_NAME_DIGITAL(__LINE__, COOLANT_AIR_PIN)
#endif
...
REPORT_NAME_DIGITAL(__LINE__, Z_BRAKE_PIN)
#endif
#if PIN_EXISTS(Z_MAX)
...
#endif
#if PIN_EXISTS(A_MAX)
REPORT_NAME_DIGITAL(__LINE__, A_MAX_PIN)
#endif
#if PIN_EXISTS(A_MIN)
REPORT_NAME_DIGITAL(__LINE__, A_MIN_PIN)
#endif
...
#if PIN_EXISTS(ATC_EJECT_SENSOR)
REPORT_NAME_DIGITAL(__LINE__, ATC_EJECT_SENSOR_PIN)
#endif

#if PIN_EXISTS(ATC_LOCK_SENSOR)
REPORT_NAME_DIGITAL(__LINE__, ATC_LOCK_SENSOR_PIN)
#endif

#if PIN_EXISTS(ATC_MANUAL_SWITCH)
REPORT_NAME_DIGITAL(__LINE__, ATC_MANUAL_SWITCH_PIN)
#endif

#if PIN_EXISTS(ATC_DOCK_SENSOR)
REPORT_NAME_DIGITAL(__LINE__, ATC_DOCK_SENSOR_PIN)
#endif

#if PIN_EXISTS(SPINDLE_FAN)
REPORT_NAME_DIGITAL(__LINE__, SPINDLE_FAN_PIN)
#endif