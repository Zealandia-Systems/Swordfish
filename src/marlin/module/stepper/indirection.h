...
//
    ...
    #define  ENABLE_STEPPER_B() B_ENABLE_WRITE( B_ENABLE_ON)
  #else
  ...
  #if E_STEPPERS > 1 && HAS_B_ENABLE
    #define DISABLE_STEPPER_B() B_ENABLE_WRITE(!B_ENABLE_ON)
  #else
    ...
    #define  ENABLE_STEPPER_C() C_ENABLE_WRITE( C_ENABLE_ON)
  #else
  ...
  #if E_STEPPERS > 2 && HAS_C_ENABLE
    #define DISABLE_STEPPER_C() C_ENABLE_WRITE(!C_ENABLE_ON)
  #else
