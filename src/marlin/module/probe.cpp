...
xyz_pos_t Probe::offset; // Initialized by settings.load()
  ...
  inline void run_deploy_moves_script() {
      ...
      TERN_(HOST_PROMPT_SUPPORT, host_prompt(PROMPT_USER_CONTINUE, PSTR("Deploy TouchMI"), CONTINUE_STR));
...
FORCE_INLINE void probe_specific_action(const bool deploy) {
    ...
    do {
      ...
      TERN_(HOST_PROMPT_SUPPORT, host_prompt(PROMPT_USER_CONTINUE, PSTR("Stow Probe"), CONTINUE_STR));
