...
inline bool line_to_destination_kinematic() {
	...
	const xyza_float_t diff = destination - current_position;
...
#		endif
	...
	const xyza_float_t segment_distance = diff * inv_segments;
...
#		endif
	...
	xyza_pos_t raw = current_position;
...
#	define RAISED raised_parked_position
			...
			case DXC_DUPLICATION_MODE:
				if (active_extruder == 0) {
					xyza_pos_t new_pos = current_position;
