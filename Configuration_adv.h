...
#define HOMING_BUMP_MM      { 15, 15, 15 }       // (mm) Backoff from endstops after first bump
...
//
  ...
  #define OTHER_PIN_LAYOUT  // Define pins manually below
    ...
    #define CLCD_MOD_RESET  29
    #define CLCD_SPI_CS    27
...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  #define MIN_CIRCLE_SEGMENTS       128 // Minimum number of segments in a complete circle
 ...
 */
    ...
    #define X_MAX_CURRENT     2000  // (mA)
    #define X_SENSE_RESISTOR    68  // (mOhms)
    #define X_MICROSTEPS        16  // Number of microsteps
  #endif

  #if AXIS_DRIVER_TYPE_X2(TMC26X)
    #define X2_MAX_CURRENT    2000
    #define X2_SENSE_RESISTOR   68
    #define X2_MICROSTEPS       16
  #endif

  #if AXIS_DRIVER_TYPE_Y(TMC26X)
    #define Y_MAX_CURRENT     2000
    #define Y_SENSE_RESISTOR    68
    #define Y_MICROSTEPS        16
  #endif

  #if AXIS_DRIVER_TYPE_Y2(TMC26X)
    #define Y2_MAX_CURRENT    2000
    #define Y2_SENSE_RESISTOR   68
    #define Y2_MICROSTEPS       16
  #endif

  #if AXIS_DRIVER_TYPE_Z(TMC26X)
    #define Z_MAX_CURRENT     2000
    #define Z_SENSE_RESISTOR    68
    #define Z_MICROSTEPS        16
  #endif

  #if AXIS_DRIVER_TYPE_Z2(TMC26X)
    #define Z2_MAX_CURRENT    1000
    #define Z2_SENSE_RESISTOR   68
 ...
 */
  ...
  #define INTERPOLATE      true
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       2800        // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     16        // 0..256
    #define X_RSENSE          0.68
    ...
    #define X2_MICROSTEPS    16
    #define X2_RSENSE         0.68
    #define X2_CHAIN_POS     -1
    //#define X2_INTERPOLATE true
  #endif

  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       2800
    #define Y_CURRENT_HOME  Y_CURRENT
    #define Y_MICROSTEPS     16
    #define Y_RSENSE          0.68
    #define Y_CHAIN_POS      -1
    //#define Y_INTERPOLATE  true
  #endif

  #if AXIS_IS_TMC(Y2)
    #define Y2_CURRENT      2800
    #define Y2_CURRENT_HOME Y2_CURRENT
    #define Y2_MICROSTEPS    16
    #define Y2_RSENSE         0.68
    #define Y2_CHAIN_POS     -1
    //#define Y2_INTERPOLATE true
  #endif

  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       2800
    #define Z_CURRENT_HOME  Z_CURRENT
    #define Z_MICROSTEPS     16
    #define Z_RSENSE          0.68
  ...
  #define MONITOR_DRIVER_STATUS
		...
		#define MONITOR_DRIVER_STATUS_INTERVAL_MS 500
...
//#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    #define SPEED_POWER_MAX           18000    // (RPM) SuperPID router controller 0 - 30,000 RPM
    #define SPEED_POWER_STARTUP       10000    // (RPM) M3/M4 speed/power default (with no arguments)

		#define SPINDLE_MODBUS
	
		#if ENABLED(SPINDLE_MODBUS)
		  #define MODBUS_SERIAL_PORT 3
		  #define MODBUS_SERIAL_BAUD 38400
			#define SPINDLE_MODBUS_TYPE CHANGRONG_H100
			#define SPINDLE_MODBUS_ADDRESS     1
		#endif
		#else
...
#define COOLANT_CONTROL
  ...
  #define COOLANT_FLOOD_INVERT false  // Set "true" if the on/off function is reversed
	#define COOLANT_AIR_INVERT   false
#endif
